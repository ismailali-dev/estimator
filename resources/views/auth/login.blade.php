            ...
            <div class="sign-wrapper mg-lg-l-50 mg-xl-l-60">
                ...
                <div class="wd-100p">
                   ...
                   <div class="text-center" style="max-width: 350px;">
                       ...
                       <br><br>
                       <h3 class="tx-25 mg-b-30">Login</3>
                   </div>
                    ...
                    <div class="tx-13 mg-t-20 tx-center">Copyright © {{date('Y')}} Developed by <a href="https://designspartans.com/" target="_blank">Design Spartans</a></div>
                </div>
            </div><!-- sign-wrapper -->
        </div><!-- media -->
    </div><!-- container -->
