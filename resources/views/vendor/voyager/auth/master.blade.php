...
<div class="container-fluid">
    <div class="row">
                ...
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        ...
                        <div class="copy animated fadeIn">
                            ...
                            <p style="display: none;">{{ Voyager::setting('admin.description', __('voyager::login.welcome')) }}</p>
                            <p>Quick - Easy - Accurate</p>
                        </div>
        ...
        <div class="col-xs-12 col-sm-5 col-md-6 login-sidebar">
