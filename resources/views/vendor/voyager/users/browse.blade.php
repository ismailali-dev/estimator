                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @foreach($dataType->browseRows as $row)
                                            ...
                                            @endphp
                                            <td class="{{ is_numeric($data->{$row->field}) ? 'text-right' : 'text-left' }}">
                                        ...
                                        @endforeach
    <td class="no-sort no-click bread-actions" style="white-space: nowrap;">
    <div style="display:flex; justify-content:center; gap:5px;">

        @php
            $availableActions = collect($actions)
                ->reject(fn($action) => method_exists($action, 'massAction'))
                ->keyBy(fn($action) => strtolower($action->getTitle()));
        @endphp

        {{-- VIEW --}}
        @if(isset($availableActions['view']))
            <a href="{{ route('voyager.'.$dataType->slug.'.show', $data->getKey()) }}"
        ...
        @endif
         ...
         {{-- EDIT --}}
        @if(isset($availableActions['edit']))
        ...
        {{-- DELETE --}}
        @if(isset($availableActions['delete']))
            <a href="javascript:;" 
